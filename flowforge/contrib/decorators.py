...
#
# Decorator API — planned for v0.4.0
# Not imported by default. Opt-in via:
#   from flowforge.contrib.decorators import workflow, step
#
# This file is a placeholder. Implementation will follow in v0.4.0.

raise NotImplementedError(
    "The FlowForge decorator API is planned for v0.4.0 and is not yet implemented. "
